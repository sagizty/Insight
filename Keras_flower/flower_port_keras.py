...
model_path = os.path.join(project_data_path, model_h5name)
...
# 测试图片位置，，输出存储cam图片的位置
test_pic_path = os.path.join(all_data_path, '1044296388_912143e1d4.jpg')

plot_pic_path = os.path.join(project_data_path, 'resultpic2.jpg')
