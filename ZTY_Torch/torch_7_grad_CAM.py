...
def comp_class_vec(ouput_vec, index=None):
    ...
    class_vec = torch.sum(one_hot * ouput_vec)  # one_hot = 11.8605  #ouput
...
def training(trainloader, net, criterion, optimizer, PATH):
    # 注册hook
...
if __name__ == '__main__':
    ...
    training(trainloader, net, criterion, optimizer, PATH='./modeltest.pth')
