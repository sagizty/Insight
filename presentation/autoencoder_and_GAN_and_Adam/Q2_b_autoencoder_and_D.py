...
def train(Generator, Discriminator, train_loader, test_loader, criterion, rec_criterion, optimizerG, optimizerD,
    ...
    for epoch in range(epochs):
        ...
        for batch_idx, (inputs, labels) in tqdm(enumerate(train_loader)):
            ...
            identity_label.fill_(real_label)  # fake labels are set to real for award generator (loss on the opposite)
            ...
            D_G_z2 = 1 - identity_output.mean().item()  # acc on not identify fake-real
...
if __name__ == '__main__':
    ...
    Generator = AutoEncoder(hidden_1=hidden_1, hidden_2=hidden_2, hidden_3=hidden_3)
